...
namespace AirlineInfo
{
    class FlightInformation
    {
        ...
        public FlightInformation(string message)
        {
            if (message == "empty")
            {
                NullFlightInformationAutomaticalInitializer();
            }
        }
        ...
        public void NullFlightInformationAutomaticalInitializer()
        {

            FlightNumber = null;
            arrayFlightInformation[0] = null;

            Airline = null;
            arrayFlightInformation[1] = null;

            //departureDateTime = null;
            arrayFlightInformation[2] = null;

            //arrivalDateTime = null;
            arrayFlightInformation[3] = null;

            CityOfDeparture = null;
            arrayFlightInformation[4] = null;

            PortOfDeparture = null;
            arrayFlightInformation[5] = null;

            CityOfArrival = null;
            arrayFlightInformation[6] = null;

            PortOfArrival = null;
            arrayFlightInformation[7] = null;

            Terminal = null;
            arrayFlightInformation[8] = null;
