...
namespace AirlineInfo
{
    ...
    class FlightStatus
    {
        ...
        public FlightStatus(string message)
        {
            if(message == "empty")
            {
                NullFlightStatusAutomaticalInitializer();
            }
        }
        ...
        public void NullFlightStatusAutomaticalInitializer()
        {

            arrayFlightStatus[0] = null;
            arrayFlightStatus[1] = null;
            arrayFlightStatus[2] = null;
            arrayFlightStatus[3] = null;
            arrayFlightStatus[4] = null;
            arrayFlightStatus[5] = null;
            arrayFlightStatus[6] = null;
            arrayFlightStatus[7] = null;
            arrayFlightStatus[8] = null;
