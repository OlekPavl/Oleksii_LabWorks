...
namespace AirlineInfo
{
    class Passenger : IPassenger
    {
        ...
        public Passenger(string message)
        {
            if(message == "empty")
            {
                NullPassengerAutomaticalInitializer();
            }
        }
        ...
        public void NullPassengerAutomaticalInitializer()
        {
            arrayPassenger[0] = null;
            arrayPassenger[1] = null;
            arrayPassenger[2] = null;
            arrayPassenger[3] = null;
            arrayPassenger[4] = null;
            arrayPassenger[5] = null;
            arrayPassenger[6] = null;
            arrayPassenger[7] = null;
        }
    }
}
