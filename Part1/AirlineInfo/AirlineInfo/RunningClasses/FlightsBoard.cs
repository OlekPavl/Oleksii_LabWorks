...
namespace AirlineInfo
{
    class FlightsBoard
    {
        ...
        public void DisplayFlightPassengerListWithoutHeader1(Passenger[] passengerList)
        {
        ...
        public void DisplayFlightPassengerListWithoutHeader(Passenger[] passengerList)
        {
            ...
            for (int i = 0; i < flightPassengers.GetLength(0); i++)
            {
                ...
                {
                    flightPassengers[i, j] = new StringBuilder();
                    if (passengerList[i].arrayPassenger[j] == null)
                    {
                        passengerList[i].arrayPassenger[j] = "";
                    }
                    flightPassengers[i, j].Append(passengerList[i].arrayPassenger[j]);
                    switch (j)
                    {
                        case 0:
                            for (int k = 0; k < (11 - passengerList[i].arrayPassenger[j].Length); k++)
                            {
                                flightPassengers[i, j].Append(" ");
                            }
                            break;
                        case 1:
                            for (int k = 0; k < (12 - passengerList[i].arrayPassenger[j].Length); k++)
                            {
                                flightPassengers[i, j].Append(" ");
                            }
                            break;
                        case 2:
                            ...
                            break;
                        case 3:
                            for (int k = 0; k < (14 - passengerList[i].arrayPassenger[j].Length); k++)
                            {
                                flightPassengers[i, j].Append(" ");
                            }
                            break;
                        case 4:
                            for (int k = 0; k < (9 - passengerList[i].arrayPassenger[j].Length); k++)
                            {
                                flightPassengers[i, j].Append(" ");
                            }
                            break;
                        case 5:
                            for (int k = 0; k < (15 - passengerList[i].arrayPassenger[j].Length); k++)
                            {
                                flightPassengers[i, j].Append(" ");
                            }
                            break;
                        case 6:
                            for (int k = 0; k < (8 - passengerList[i].arrayPassenger[j].Length); k++)
                            {
                                flightPassengers[i, j].Append(" ");
                            }
                            break;
